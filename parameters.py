...
def basic_training_parameters(parser):
    ...
    parser.add_argument('--dataset',              default='food101',   type=str,   help='Dataset to use. Currently supported: cub200, cars196, online_products.')
    ...
    parser.add_argument('--pool', default='SPoC', type=str,help='Pooling method')
